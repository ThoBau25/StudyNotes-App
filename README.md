...
The app also displays an overview of upcoming reminders. These reminders are automatically removed once the scheduled time has been reached or passed.

Study-Notes allows users to create new learning tasks with a title and a description. Both fields are mandatory, and if they are left empty, a dialog appears to inform the user. Furthermore, users can set a time-based reminder, attach learning materials from the photo gallery, and assign an emoji that represents the current learning progress.
